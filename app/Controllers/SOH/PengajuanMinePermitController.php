...
class PengajuanMinePermitController extends BaseController
{
    ...
    public function index(): string
    {
        ...
        return view('soh/pengajuan_id_card', $data);
    }
    ...
    public function detail($id)
    {
        ...
        if($minePermit){
            ...
            return view('soh/detail.php', $data);
        }else{
    ...
    public function detailPengajuan($id)
    {
        ...
        if($minePermit){
            ...
            return view('soh/detail-pengajuan.php', $data);
        }else{
            echo "id card tidak ditemukan";
        }
    }
    ...
    public function detailIDCard($id)
    {
        ...
        if($minePermit){
            ...
            return view('soh/detailIDCard.php', $data);
        }else{
            echo "id card tidak ditemukan";
        }
    }
    ...
    public function postInstanCreate()
    {
        ...
        return redirect()->to("/soh/id_card")->with("success", "Success! Mine permit berhasil ditambah.");
    ...
    public function postAjukanApprove()
    {
        ...
        return redirect()->to("/soh/id_card")->with("success", "Success! Mine permit berhasil disetujui.");
        // return redirect()->to("/" . $outputPathMinePermit)->with("success", "Success! mine permit berhasil ditambah.");
    }
    public function postAjukanReject()
    {
        ...
        return redirect()->to("/soh/id_card")->with("success", "Success! Mine permit berhasil ditolak.");
        // return redirect()->to("/" . $outputPathMinePermit)->with("success", "Success! mine permit berhasil ditambah.");
    }
...
public function postDelete()
    {
        ...
        if ($id) {
            ...
            if ($simper) {
                ...
                return redirect()->to('/soh/id_card')->with('success', 'Success! Mine Permit berhasil dihapus.');
                
            } else {
                return redirect()->to('/soh/id_card')->with('error', 'Failed! Mine Permit tidak ditemukan.');
            }
        } else {
            return redirect()->to('/soh/id_card')->with('error', 'Failed! ID tidak valid.');
        }
    }
}