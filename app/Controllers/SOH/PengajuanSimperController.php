...
class PengajuanSimperController extends BaseController
{
    ...
    public function index(): string
    {
        ...
        $data = [
            ...
            "simpers" => $this->simperModel->orderBy("created_at", "DESC")->findAll(),
        ];
        // $data['company'] = $companyModel->find($companyId);
        // $data['anggota'] = $anggotaModel->getAnggotaData($companyId);
        return view('soh/pengajuan_simper', $data);
    }
    ...
    public function detail($id)
    {
        ...
        if($simper){
            ...
            return view('soh/detail_simper.php', $data);
        }else{
    ...
    public function detailPengajuan($id)
    {
        ...
        if($simper){
            ...
            return view('soh/detail-pengajuan-simper.php', $data);
        }else{
            echo "id card tidak ditemukan";
        }
    }
    ...
    public function postAjukanApprove()
    {
        ...
        $data = (object) [
            'approval_soh' => "accepted", // Menyimpan path file
        ];

        $this->simperModel->update($id,  $data);

        return redirect()->to("/soh/simper")->with("success", "Success! Simper berhasil disetujui.");
    ...
    public function postAjukanReject()
    {
        $id = $this->request->getPost("id");
        $data = (object) [
            'approval_soh' => "rejected", // Menyimpan path file
        ];

        $this->simperModel->update($id,  $data);

        return redirect()->to("/soh/simper")->with("success", "Success! Simper berhasil ditolak.");
        // return redirect()->to("/" . $outputPathMinePermit)->with("success", "Success! Simper berhasil ditambah.");
    }
    ...
    public function detailIDCard($id)
    {
        ...
        if($simper){
            ...
            return view('soh/detailIDCardSimper.php', $data);
        }else{
            echo "id card tidak ditemukan";
        }
    }
    ...
    public function postInstanCreate()
    {
        ...
        return redirect()->to("/soh/simper")->with("success", "Success! Simper berhasil ditambah.");
        // return redirect()->to("/" . $outputPathMinePermit)->with("success", "Success! Simper berhasil ditambah.");
    }
    ...
    {
        $backgroundPath = 'simper/simper_belakang_bg.png';
...
// {
//     $backgroundPath = 'simper/simper_belakang_bg.jpg';
...
public function postDelete()
    {
        ...
        if ($id) {
            ...
            if ($simper) {
                ...
                return redirect()->to('/soh/simper')->with('success', 'Success! Simper berhasil dihapus.');
            } else {
                return redirect()->to('/soh/simper')->with('error', 'Failed! Simper tidak ditemukan.');
            }
        } else {
            return redirect()->to('/soh/simper')->with('error', 'Failed! ID tidak valid.');
        }
    }
