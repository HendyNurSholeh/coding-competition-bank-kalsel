...
class ProfileController extends BaseController
{
    public function index(): string
    {
        ...
        return view('operator/profile', ['profileData' => $profileData, 'activeMenu' => 'profile']);
    }
    ...
    public function resetPassword() {
        ...
        return redirect()->to('/operator/profile')->with('success', 'Success!, Password berhasil diubah.');
    }
    ...
    public function profileEdit (): string
    {
        ...
        // Render view dengan data yang sudah diambil
        return view('operator/profile-edit', ['profileData' => $profileData, 'activeMenu' => 'profile']);
    }
    ...
    public function postEdit()
{
   ...
   if (!empty($croppedImage)) {
    ...
    return redirect()->to('/operator/profile')->with('success', 'Berhasil! profile berhasil diperbarui.');
}
}