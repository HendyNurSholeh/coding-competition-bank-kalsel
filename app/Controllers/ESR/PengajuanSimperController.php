...
class PengajuanSimperController extends BaseController
{
    ...
    public function index(): string
    {
        ...
        return view('esr/pengajuan_simper', $data);
    }
    ...
    public function detail($id)
    {
        ...
        if($simper){
            ...
            return view('esr/detail_simper.php', $data);
        }else{
    ...
    public function detailPengajuan($id)
    {
        ...
        if($simper){
            ...
            return view('esr/detail-pengajuan-simper.php', $data);
        }else{
            echo "id card tidak ditemukan";
        }
    }
    ...
    public function postAjukanApprove()
    {
        ...
        $data = (object) [
            'approval_esr' => "accepted", // Menyimpan path file
        ];

        $this->simperModel->update($id,  $data);

        return redirect()->to("/esr/simper")->with("success", "Success! Simper berhasil disetujui.");
    ...
    public function postAjukanReject()
    {
        $id = $this->request->getPost("id");
        $data = (object) [
            'approval_esr' => "rejected", // Menyimpan path file
        ];

        $this->simperModel->update($id,  $data);

        return redirect()->to("/esr/simper")->with("success", "Success! Simper berhasil ditolak.");
        // return redirect()->to("/" . $outputPathMinePermit)->with("success", "Success! Simper berhasil ditambah.");
    }
    ...
    public function detailIDCard($id)
    {
        ...
        if($simper){
            ...
            return view('esr/detailIDCardSimper.php', $data);
        }else{
            echo "id card tidak ditemukan";
        }
    }
    ...
    public function postInstanCreate()
    {
        ...
        return redirect()->to("/esr/simper")->with("success", "Success! Simper berhasil ditambah.");
        // return redirect()->to("/" . $outputPathMinePermit)->with("success", "Success! Simper berhasil ditambah.");
    }
...
public function postDelete()
    {
        ...
        if ($id) {
            ...
            if ($simper) {
                ...
                return redirect()->to('/esr/simper')->with('success', 'Success! Simper berhasil dihapus.');
            } else {
                return redirect()->to('/esr/simper')->with('error', 'Failed! Simper tidak ditemukan.');
            }
        } else {
            return redirect()->to('/esr/simper')->with('error', 'Failed! ID tidak valid.');
        }
    }
