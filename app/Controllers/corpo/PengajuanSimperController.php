...
class PengajuanSimperController extends BaseController
{
    ...
    public function index(): string
    {
        ...
        $data = [
            ...
            "simpers" => $this->simperModel->where("approval_corpo !=", "not_applicable")->orderBy("created_at", "DESC")->findAll(),
        ];
        // $data['company'] = $companyModel->find($companyId);
        // $data['anggota'] = $anggotaModel->getAnggotaData($companyId);
        return view('corpo/pengajuan_simper', $data);
    }
    ...
    public function detail($id)
    {
        ...
        if($simper){
            ...
            return view('corpo/detail_simper.php', $data);
        }else{
    ...
    public function detailPengajuan($id)
    {
        ...
        if($simper){
            ...
            return view('corpo/detail-pengajuan-simper.php', $data);
        }else{
            echo "id card tidak ditemukan";
        }
    }
    ...
    public function postAjukanApprove()
    {
        ...
        return redirect()->to("/corpo/simper")->with("success", "Success! Simper berhasil disetujui.");
    ...
    public function postAjukanReject()
    {
        ...
        return redirect()->to("/corpo/simper")->with("success", "Success! Simper berhasil ditolak.");
        // return redirect()->to("/" . $outputPathMinePermit)->with("success", "Success! Simper berhasil ditambah.");
    }
    ...
    public function detailIDCard($id)
    {
        ...
        if($simper){
            ...
            return view('corpo/detailIDCardSimper.php', $data);
        }else{
            echo "id card tidak ditemukan";
        }
    }
    ...
    public function postInstanCreate()
    {
        ...
        return redirect()->to("/corpo/simper")->with("success", "Success! Simper berhasil ditambah.");
        // return redirect()->to("/" . $outputPathMinePermit)->with("success", "Success! Simper berhasil ditambah.");
    }
...
public function postDelete()
    {
        ...
        if ($id) {
            ...
            if ($simper) {
                ...
                return redirect()->to('/corpo/simper')->with('success', 'Success! Simper berhasil dihapus.');
            } else {
                return redirect()->to('/corpo/simper')->with('error', 'Failed! Simper tidak ditemukan.');
            }
        } else {
            return redirect()->to('/corpo/simper')->with('error', 'Failed! ID tidak valid.');
        }
    }
