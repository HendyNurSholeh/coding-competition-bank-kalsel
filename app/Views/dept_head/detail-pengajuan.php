                    ...
                    <div class="card-body pt-0 p-10">
                        ...
                        <div class="d-flex flex-center flex-column">
                            ...
                            <div class="symbol  mb-3 symbol-100px symbol-circle "><img alt="Pic"
                                    src="/uploads/pas_foto/<?= $minePermit['pas_foto_image']; ?>" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Name-->
                        ...
                        <ul
                            ...
                            <li class="menu-item mb-1">
                                <a class="menu-link px-6 py-4 active mt-3 mt-lg-0"
                                    href="<?=base_url()?>/dept_head/id_card/detail/<?=$minePermit['id']?>">
                            ...
                            <li class="menu-item mb-1">
                                ...
                                <a class="menu-link px-6 py-4 "
                                    href="<?=base_url()?>/dept_head/id_card/detail/id_card/<?=$minePermit['id']?>">
                                    <span class="menu-bullet"><span class="bullet"></span></span>
                                    <span class="menu-title">
                                        ID Card </span>
                                </a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?=base_url()?>/dept_head/id_card/post-ajukan-approve" method="post">
...
<div class="modal fade" tabindex="-1" id="modalRejected">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?=base_url()?>/dept_head/id_card/post-ajukan-reject" method="post">
                    <input type="hidden" name="id" id="id" value="<?= $minePermit['id']; ?>">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
