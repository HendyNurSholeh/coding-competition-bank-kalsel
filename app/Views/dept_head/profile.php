                    ...
                    <div class="card-body p-10 pb-2">
                        ...
                        <div class="d-flex flex-center flex-column mb-10">
                            ...
                            <div class="fs-6 fw-bold text-gray-400 mb-lg-3"><span
                                    class="badge bg-primary me-2 card-rounded">Admin</span></div>
                            <!--end::Position-->
                            <!--begin::Actions-->
                            <!--end::Actions-->
                        </div>
            ...
            <div class="flex-lg-row-fluid ms-lg-10">
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-header cursor-pointer">
                        ...
                        <!--end::Card title-->
                        <!--begin::Action-->
                        <!-- <a href="profile-edit" class="btn btn-primary align-self-center">Edit Profile</a> -->
                        <!--end::Action-->
                    </div>
                    <!--begin::Card header-->
                    <!--begin::Card body-->
                    <div class="card-body p-9 ">
                        <!--begin::Row-->
                        <!-- <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">Nama <i
                                    class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                    title="Country of origination"></i></label>
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-dark"><?= esc(ucwords($profileData['username']) ?? '') ?></span>
                            </div>
                        </div> -->
                        <!--end::Row-->
                        <!--begin::Input group-->
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body px-5 my-7">
                                        ...
                                        <form id="kt_modal_reset_password_form" class="form"
                                            action="<?= base_url(); ?>dept_head/profile/reset-password" method="post">
                                            <!--begin::Scroll-->
