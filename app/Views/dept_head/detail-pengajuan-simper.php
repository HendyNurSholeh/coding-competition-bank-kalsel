                    ...
                    <div class="card-body pt-0 p-10">
                        ...
                        <div class="d-flex flex-center flex-column">
                            ...
                            <div class="symbol  mb-3 symbol-100px symbol-circle "><img alt="Pic"
                                    src="/uploads/pas_foto/<?= $simper['pas_foto_image']; ?>" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Name-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?=base_url()?>/dept_head/simper/post-ajukan-approve" method="post">
...
<div class="modal fade" tabindex="-1" id="modalRejected">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?=base_url()?>/dept_head/simper/post-ajukan-reject" method="post">
                    <input type="hidden" name="id" id="id" value="<?= $simper['id']; ?>">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
