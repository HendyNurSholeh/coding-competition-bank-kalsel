...
<body id="kt_body" class="auth-bg">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <style>
        .auth-page-bg {
            /* background-image: url('<?phpbase_url()?>/assets/media/illustrations/dozzy-1/14.png'); */
        }

        [data-bs-theme="dark"] .auth-page-bg {
            /* background-image: url('<?phpbase_url()?>/assets/media/illustrations/dozzy-1/14-dark.png'); */
        }
        </style>
