                        ...
                        <div class="card card-xxl-stretch">
                            <div class="card-body py-0">
                                <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="col-12 pb-xxl-5 mb-4 mt-4">
                                                ...
                                                <table id="kt_datatable_dom_positioning3" width="100%"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php foreach($simpers_waiting as $index => $row): ?>
                                                        <tr>
                                                            <td><?= $index+1; ?></td>
                                                            <td><?= $row['nrp']; ?></td>
                                                            <td><?= $row['nama']; ?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button class="btn btn-secondary">Not
                                                                    Applicable</button>
                                                                <span class="badge badge-light-danger">Rejected</span>
                                                                <?php else: ?>
                                                            ...
                                                            <td>
                                                                <a href="<?=base_url()?>/dept_head/simper/detail/<?=$row['id']?>"
                                                                    type="button"
                                    ...
                                    <div class="tab-pane fade fade " id="kt_tab_pane_4" role="tabpanel">
                                        <div class="row mt-3 mb-5 mb-lg-0 pb-5">
                                            ...
                                            <div class="col-12 pb-xxl-5 mb-4 mt-3">
                                                <table id="kt_datatable_dom_positioning" width="100%"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php foreach($simpers_accept as $index => $row): ?>
                                                        <tr>
                                                            <td><?= $index+1; ?></td>
                                                            <td><?= $row['uniq_id']; ?></td>
                                                            <td><?= $row['nama']; ?></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?=base_url()?>/dept_head/simper/post-delete" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5 my-7">
                    ...
                    <form id="kt_modal_add_anggota_form" class="form"
                        action="<?=base_url()?>/dept_head/simper/post-instan-create" method="post"
    ...
    <div class="modal fade" id="kt_modal_add_pengajuan" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="kt_modal_add_user_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Buat Pengajuan Simper</h2>
                    <!--end::Modal title-->
                ...
                <div class="modal-body px-5 my-7">
                    ...
                    <form id="kt_modal_add_anggota_form" class="form form-pengajuan"
                        action="<?=base_url()?>/dept_head/simper/post-ajukan-simper" method="post"
                        enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_anggota_scroll"
    ...
    <div class="modal fade" tabindex="-1" id="modalDone">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?=base_url()?>/dept_head/simper/post-continue-done" method="post">
                        <input type="hidden" name="id" id="id">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
...
$(document).ready(function() {
    ...
    $('#add_unit').click(function() {
        var unitCount = $('#kt_modal_add_user #unit_recommendation_container .unit-recommendation')
