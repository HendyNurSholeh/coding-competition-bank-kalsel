                    ...
                    <div>
                        ...
                        <div class="card card-xxl-stretch">
                            ...
                            <div class="card-header border-0 pt-5 pb-3">
                                <!--begin::Card title-->
                                <h3 class="card-title fw-bolder text-gray-800 fs-3">Kelola Data
                                </h3>
                                <!--end::Card title-->
                                <!--begin::Card toolbar-->
                                        ...
                                        <table id="kt_datatable_dom_positioning" width="100%"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row['gol_darah']; ?></td>
                                                    <td>
                                                        <?php if($row['card_image']): ?>
                                                        <img src="/uploads/<?= $row['card_image']; ?>" alt="Card Image"
                                                            width="100">
                                                        <?php else: ?>
                                                        No Image
                                                        <?php endif; ?>
                                                    </td>
                                                    <td><a href="/lihat-foto"
                                                            style="text-decoration: underline">unduh</a></td>
                                                </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="kt_modal_add_user_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Ajukan ID Card Anggota</h2>
                    <!--end::Modal title-->
                ...
                <div class="modal-body px-5 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_add_anggota_form" class="form" action="/admin/anggota/post-add" method="post"
