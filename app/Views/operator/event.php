                    ...
                    <div>
                        ...
                        <div class="card card-xxl-stretch">
                            ...
                            <div class="card-header border-0 pt-5 pb-3">
                                <!--begin::Card title-->
                                <h3 class="card-title fw-bolder text-gray-800 fs-2">Daftar Event
                                </h3>
                                <!--end::Card title-->
                                <!--begin::Card toolbar-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <ny class="modal-title">Konfirmasi Hapus Event</ny>
    ...
    <div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="kt_modal_add_user_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Tambah Event</h2>
                    <!--end::Modal title-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="fv-row mb-7">
                                        ...
                                        <select name="event_type" class="form-control form-control-solid mb-3 mb-lg-0"
                                            required>
                                            <option value="">Pilih jenis acara</option>
                                            <option value="WCC1">Pelatihan</option>
                                            <option value="WCC2">Seminar</option>
                                            <option value="WCC3">Workshop</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
