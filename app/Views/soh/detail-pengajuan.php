        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                ...
                <div class="card card-flush" data-kt-sticky="true" data-kt-sticky-name="account-navbar"
                    ...
                    <div class="card-header justify-content-between">
                        ...
                        <div class="card-toolbar">
                            <?php if($minePermit['approval_soh'] == "approved"): ?>
                        ...
                        <ul
                            ...
                            <li class="menu-item mb-1">
                                ...
                                <a class="menu-link px-6 py-4 "
                                    href="<?=base_url()?>/soh/id_card/detail/id_card/<?=$minePermit['id']?>">
                                    <span class="menu-bullet"><span class="bullet"></span></span>
                                    <span class="menu-title">
                                        ID Card </span>
                                </a>
            ...
            <div class="flex-lg-row-fluid ms-lg-10">
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <!--begin::Card body-->
                    <div class="card-body p-9 <?= $minePermit['approval_soh'] == "waiting" ? "pt-0" : ""; ?>">
                        <!--begin::Row-->
                        <?php if($minePermit['approval_soh'] == "waiting"): ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?=base_url()?>/soh/id_card/post-ajukan-approve" method="post">
...
<div class="modal fade" tabindex="-1" id="modalRejected">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?=base_url()?>/soh/id_card/post-ajukan-reject" method="post">
                    <input type="hidden" name="id" id="id" value="<?= $minePermit['id']; ?>">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
