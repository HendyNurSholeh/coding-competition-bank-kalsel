                    ...
                    <div class="card-body p-10 pb-2">
                        ...
                        <div class="d-flex flex-center flex-column mb-10">
                            ...
                            <div class="fs-6 fw-bold text-gray-400 mb-lg-3"><span
                                    class="badge bg-primary me-2 card-rounded">Site Operation Head</span>
                            </div>
                            <!--end::Position-->
                        </div>
                        <!--end::Summary-->
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-body p-9 ">
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <span class="fw-bold fs-6">Site Operation Head (SOH)</span>
                            </div>
                            <!--end::Col-->
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body px-5 my-7">
                                        ...
                                        <form id="kt_modal_reset_password_form" class="form"
                                            action="<?= base_url(); ?>soh/profile/reset-password" method="post">
                                            <!--begin::Scroll-->
