                                                ...
                                                <table id="kt_datatable_dom_positioning3" width="100%"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?=base_url()?>/corpo/id_card/detail-pengajuan/<?=$row['id']?>"
                                                                    type="button"
                                                ...
                                                <table id="kt_datatable_dom_positioning" width="100%"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?=base_url()?>/corpo/id_card/detail/<?=$row['id']?>"
                                                                    type="button"
                                                                    class="btn py-1 btn-light-info btn-sm me-2">
                                                                    <i class="bi bi-person-badge-fill"></i>
                                                                </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?=base_url()?>/corpo/id_card/post-delete" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5 my-7">
                    ...
                    <form id="kt_modal_add_anggota_form" class="form"
                        action="<?=base_url()?>/corpo/id_card/post-instan-create" method="post"
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_add_anggota_form" class="form"
                        action="<?=base_url()?>/corpo/id_card/post-ajukan-minepermit" method="post"
                        enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_anggota_scroll"
