                                                ...
                                                <table id="kt_datatable_dom_positioning3" width="100%"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?=base_url()?>/corpo/simper/detail-pengajuan/<?=$row['id']?>"
                                                                    type="button"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?=base_url()?>/corpo/simper/post-delete" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5 my-7">
                    ...
                    <form id="kt_modal_add_anggota_form" class="form"
                        action="<?=base_url()?>/corpo/simper/post-instan-create" method="post"
