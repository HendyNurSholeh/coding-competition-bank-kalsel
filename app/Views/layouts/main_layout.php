...
<head>
    ...
    <link rel="shortcut icon" href="/image/logo-cropped.png" />
...
<div class="nav-container">
    <div class="nav-mob">
        ...
        <div class="navigation-mob">
            <ul>
                <li class="list <?= $activeMenu == "account management" ? "active" : ""; ?>">
                    <a href="/admin/mb-management-akun">
                        <span class="icon">
                            <ion-icon name="people-outline" style="font-size: 1.15em !important;"></ion-icon>
                        </span>
                ...
                <li
                    class="list <?= $activeMenu == "broker" || $activeMenu == "zone" || $activeMenu == "size" ? "active" : ""; ?>">
                    <a href="/admin/mb-management-data">
                        <span class="icon">
                ...
                <li class="list <?= $activeMenu == "posko" ? "active" : ""; ?>">
                    <a href="/admin/posko-price">
                        <span class="icon">
                            <ion-icon name="cash-outline"></ion-icon>
                        </span>
                        <span class="text">Harga Posko</span>
                        <span class="circle"></span>
                    </a>
                </li>
                    ...
                    <div class="container-xxl d-flex align-items-center">
                        ...
                        <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
                            <a href="/admin/dashboard">
                                <img alt="Logo" src="/image/logo.png" style="border-radius: 8px;"
                                    class="h-25px h-lg-35px logo-default" />
                                <img alt="Logo" src="/image/logo.png" class="h-35px h-lg-40px logo-sticky" />
                            </a>
                        </div>
                        <!--end::Header Logo-->
                        <!--begin::Wrapper-->
                            ...
                            <div class="d-flex align-items-stretch" id="kt_header_nav">
                                ...
                                <div class="header-menu align-items-stretch" data-kt-drawer="true"
                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                        ...
                                        <a href="/admin/dashboard" data-kt-menu-placement="bottom-start"
                                        ...
                                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                            ...
                                            class="menu-item menu-lg-down-accordion me-lg-1 <?= $activeMenu == "account management" ? "here show " : ""; ?>">
                                            <span class="menu-link py-3">
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link active py-3"
                                                        href="/admin/management_account/admin-management">
                                                            ...
                                                            <span class="svg-icon svg-icon-2">
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        fill="black" />
                                                                    <path opacity="0.3"
                                                                        d="M21 19C21 17.34 18.31 16 14.5 16C10.69 16 8 17.34 8 19V20H21V19Z"
                                                                        fill="black" />
                                                                    <path
                                                                        d="M3 20H6V19C6 17.34 8.69 16 12.5 16C12.67 16 12.84 16 13 16H14.5C14.33 16 14.16 16 14 16C9.31 16 6 17.34 6 19V20H3V19Z"
                                                                        fill="black" />
                                                                </svg>
                                                            </span>
                                                        </span>
                                                ...
                                                <!-- Anggota -->
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="/admin/management_account/karyawan">
                                                        <span class="menu-icon">
                                                            <span class="svg-icon svg-icon-2">
                                                                <!-- Ikon Anggota -->
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none">
                                                                    <path
                                                                        d="M16.5 13C18.43 13 20 14.57 20 16.5V18H13V16.5C13 14.57 14.57 13 16.5 13ZM7.5 13C9.43 13 11 14.57 11 16.5V18H4V16.5C4 14.57 5.57 13 7.5 13ZM16.5 11C14.57 11 13 9.43 13 7.5C13 5.57 14.57 4 16.5 4C18.43 4 20 5.57 20 7.5C20 9.43 18.43 11 16.5 11ZM7.5 11C5.57 11 4 9.43 4 7.5C4 5.57 5.57 4 7.5 4C9.43 4 11 5.57 11 7.5C11 9.43 9.43 11 7.5 11Z"
                                                                        fill="black" />
                                                                    <path opacity="0.3"
                                                                        d="M21 20H14V18C14 16.34 16.69 15 20.5 15C20.67 15 20.84 15 21 15V20Z"
                                                                        fill="black" />
                                                                    <path opacity="0.3"
                                                                        d="M10 20H3V18C3 16.34 5.69 15 9.5 15C9.67 15 9.84 15 10 15V20Z"
                                                                        fill="black" />
                                                                </svg>
                                                            </span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="/admin/management_account/company">
                                                        <span class="menu-icon">
                                                            <span class="svg-icon svg-icon-2">
                                                                <!-- Ikon Anggota -->
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        ...
                                                        <span class="menu-title">Dept Head</span>
                                                    </a>
                                                </div>
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="/admin/management_account/company">
                                                        ...
                                                        <span class="menu-title">Site Manager</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div data-kt-menu-placement="bottom-start"
                                            class="menu-item menu-lg-down-accordion me-lg-1 <?= $activeMenu == "anggota" ? "here show " : ""; ?>">
                                            <a href="/anggota" class="menu-link py-3">
                                                <span class="menu-title">Pengajuan Card & Simper</span>
                                                <span class="menu-arrow d-lg-none"></span>
                                            </a>
                                        </div>
                                        <div data-kt-menu-placement="bottom-start"
                                            class="menu-item menu-lg-down-accordion me-lg-1 <?= $activeMenu == "profile" ? "here show " : ""; ?>"">
                                            <a href=" /admin/profile" class="menu-link py-3 px-5">
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                            ...
                                            <div class="menu-item px-5">
                                                <a href="/admin/profile" class="menu-link px-5">Profile
                                                    Saya</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu separator-->
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-5">
                                                <a href="/auth/login" class="menu-link px-5">Sign Out</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu separator-->
                                            <div class="separator my-2"></div>
