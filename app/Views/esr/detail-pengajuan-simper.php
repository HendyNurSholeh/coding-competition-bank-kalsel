        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                ...
                <div class="card card-flush" data-kt-sticky="true" data-kt-sticky-name="account-navbar"
                    ...
                    <div class="card-header justify-content-between">
                        ...
                        <div class="card-toolbar">
                            <?php if($simper['approval_esr'] == "approved"): ?>
                        ...
                        <ul
                            ...
                            <li class="menu-item mb-1">
                                ...
                                <a class="menu-link px-6 py-4 "
                                    href="<?=base_url()?>/esr/simper/detail/simper/<?=$simper['id']?>">
                                    <span class="menu-bullet"><span class="bullet"></span></span>
                                    <span class="menu-title">
                                        ID Card </span>
                                </a>
            ...
            <div class="flex-lg-row-fluid ms-lg-10">
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <!--begin::Card body-->
                    <div class="card-body p-9 <?= $simper['approval_esr'] == "waiting" ? "pt-0" : ""; ?>">
                        <!--begin::Row-->
                        <?php if($simper['approval_esr'] == "waiting"): ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?=base_url()?>/esr/simper/post-ajukan-approve" method="post">
...
<div class="modal fade" tabindex="-1" id="modalRejected">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?=base_url()?>/esr/simper/post-ajukan-reject" method="post">
                    <input type="hidden" name="id" id="id" value="<?= $simper['id']; ?>">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
