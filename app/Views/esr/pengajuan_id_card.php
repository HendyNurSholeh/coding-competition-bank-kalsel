        ...
        <div class="card card-page">
            ...
            <div class="card-body">
                ...
                <div class="row gy-5 g-xl-8">
                    ...
                    <!--begin::Col-->
                    <div>
                        <ul class="d-none nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                                ...
                                <div class="tab-content" id="myTabContent">
                                                ...
                                                <table id="kt_datatable_dom_positioning3" width="100%"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?=base_url()?>/esr/id_card/detail-pengajuan/<?=$row['id']?>"
                                                                    type="button"
                                    ...
                                    <div class="tab-pane fade" id="kt_tab_pane_4" role="tabpanel">
                                        <div class="row mt-3 mb-5 mb-lg-0 pb-5">
                                            ...
                                            <div class="col-12 pb-xxl-5 mb-5 mt-2">
                                                <table id="kt_datatable_dom_positioning" width="100%"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?=base_url()?>/esr/id_card/detail/<?=$row['id']?>"
                                                                    type="button"
                                                                    class="btn py-1 btn-light-info btn-sm me-2">
                                                                    <i class="bi bi-person-badge-fill"></i>
                                                                </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?=base_url()?>/esr/id_card/post-delete" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5 my-7">
                    ...
                    <form id="kt_modal_add_anggota_form" class="form"
                        action="<?=base_url()?>/esr/id_card/post-instan-create" method="post"
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_add_anggota_form" class="form"
                        action="<?=base_url()?>/esr/id_card/post-ajukan-minepermit" method="post"
                        enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_anggota_scroll"
