                        ...
                        <ul
                            ...
                            <li class="menu-item mb-1">
                                <a class="menu-link px-6 py-4 mt-3 mt-lg-0"
                                    href="<?=base_url()?>/esr/id_card/detail-pengajuan/<?=$minePermit['id']?>">
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-header cursor-pointer">
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">ID Card Mine Permit</h3>
                        </div>
                    </div>
                    <!--begin::Card header-->
                            ...
                            <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                        style="background-image:url('<?=base_url()?>/<?= $minePermit['mine_permit']; ?>')">
                                    </div>
                                    <!--end::Photo-->
                                ...
                                <div class="text-center">
                                    <!--begin::Photo-->
                                    <div class="mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                        style="background-image:url('<?= base_url() . $minePermit['mine_permit_belakang']; ?>')">
                                    </div>
                                    <!--end::Photo-->
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <br>
                                        <a href="<?= base_url() . $minePermit['mine_permit_belakang']; ?>"
                                            class="mt-1 btn btn-light-info" download>
                                            <i class="bi bi-download me-2"></i> Download
                                        </a>
                                        <!--begin::Position-->
