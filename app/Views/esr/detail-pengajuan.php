<?= $this->extend('layouts/esr_layout') ?>
<?= $this->section('css') ?>
</style>
<?= $this->endSection() ?>
        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                ...
                <div class="card card-flush" data-kt-sticky="true" data-kt-sticky-name="account-navbar"
                    ...
                    <div class="card-header justify-content-between">
                        ...
                        <div class="card-toolbar">
                            <?php if($minePermit['approval_esr'] == "approved"): ?>
                            <?php if ($minePermit['masa_berlaku'] < $today) :?>
                    ...
                    <div class="card-body pt-0 p-10">
                        ...
                        <div class="d-flex flex-center flex-column">
                            ...
                            <div class="fs-6 fw-semibold text-gray-400 mb-2">
                                <?= ucwords(strtolower(trim($minePermit['jabatan']))); ?>
                            </div>
                            <!--end::Position-->
                        ...
                        <ul
                            ...
                            <!-- <li class="menu-item mb-1">
                                <a class="menu-link px-6 py-4 mt-3 mt-lg-0" href="#">
                                    <span class="menu-bullet"><span class="bullet"></span></span>
                                    <span class="menu-title">
                                        Post Test </span>
                                </a>
                            ...
                            <li class="menu-item mb-1">
                                <?php if($minePermit['approval_status'] == "approved"): ?>
                                <a class="menu-link px-6 py-4 "
                                    href="<?=base_url()?>/esr/id_card/detail/id_card/<?=$minePermit['id']?>">
                                    <span class="menu-bullet"><span class="bullet"></span></span>
                                    <span class="menu-title">
                                        ID Card </span>
                                </a>
            ...
            <div class="flex-lg-row-fluid ms-lg-10">
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <!--begin::Card body-->
                    <div class="card-body p-9 <?= $minePermit['approval_esr'] == "waiting" ? "pt-0" : ""; ?>">
                        <!--begin::Row-->
                        <?php if($minePermit['approval_esr'] == "waiting"): ?>
                            ...
                            <div
                                ...
                                <div class="d-flex flex-stack flex-grow-1 ">
                                    ...
                                    <div class=" fw-semibold">
                                        <h4 class="text-gray-900 fw-bold">Approve Mine Permit?</h4>
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-dark"><?= ucwords($minePermit['nrp']); ?></span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <div class="row mb-7">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 fv-row">
                                <span class="fw-semibold fs-6"><?= ucwords($minePermit['company']); ?></span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <span class="fw-semibold fs-6"><?= ucwords($minePermit['masaberlakuformat']); ?></span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <span class="fw-semibold fs-6"><?= strtoupper($minePermit['gol_darah']); ?></span>
                            </div>
                            <!--end::Col-->
                        </div>
                        ...
                        <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed  p-6">
                            <!--begin::Icon-->
                            <i class="far fa-lightbulb  icon-large text-warning  me-5" style="font-size: 30px"></i>
                            <!--end::Icon-->
                            ...
                            <div class="d-flex flex-stack flex-grow-1 ">
                                <!--begin::Content-->
                                <div class=" fw-semibold">
                                    <h4 class="text-gray-900 fw-bold">Hasil Post Test!</h4>
                                    <span class="badge badge-success">Jumlah Benar: 87</span>
                                    <span class="badge badge-danger">Jumlah Salah: 39</span>
                                    <div class="fs-6 text-gray-700 mt-2">
                                        <span class="fw-bold">
                                            <?= ucwords(strtolower(trim($minePermit['nama']))); ?></span> mampu menjawab
                                        87/111
                                        soal. <a style="text-decoration: underline;" href="#">lihat
                                            detail</a>.
                                    </div>
                                </div>
                                <!--end::Content-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Konfirmasi Approval Mine Permit</h3>
            ...
            <div class="modal-body">
                <p>Apakah anda yakin ingin menyetujui mine permit ini?</p>
            </div>

            <div class="modal-footer">
                <form action="<?=base_url()?>/esr/id_card/post-ajukan-approve" method="post">
                    <input type="hidden" name="id" id="id" value="<?= $minePermit['id']; ?>">
...
<div class="modal fade" tabindex="-1" id="modalRejected">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah anda yakin ingin menolak approval mine permit ini?</p>
            </div>

            <div class="modal-footer">
                <form action="<?=base_url()?>/esr/id_card/post-ajukan-reject" method="post">
                    <input type="hidden" name="id" id="id" value="<?= $minePermit['id']; ?>">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
