                ...
                <div class="toolbar py-5 py-lg-15" id="kt_toolbar">
                    ...
                    <div id="kt_toolbar_container" class=" container-xxl  d-flex flex-stack flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap py-2">
                            <!--begin::Action-->
                            <a href="<?=env('p2hURL')?>/auth/karyawan/login?id=<?= $simper['id']?>"
                                class="btn btn-custom btn-sm btn-color-white btn-active-color-success my-2 me-2 me-lg-6">
                                Form P2H
                            </a>
                                        ...
                                        <div class="d-flex flex-center flex-column">
                                            ...
                                            <a href="#" class="fs-2 text-gray-800 text-hover-primary fw-bold mb-1">
                                                ...
                                                <div class="fs-6 fw-semibold text-gray-400 mb-2">
                                                    <?= ucwords(strtolower(trim($simper['jabatan']))); ?> </div>
                                                <!--end::Position-->
                                ...
                                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                                    ...
                                    <div class="card-body p-9">
                                        ...
                                        <div class="row mb-7">
                                            ...
                                            <div class="col-lg-8">
                                                <span
                                                    class="fw-bold fs-6 text-dark"><?= ucwords($simper['nrp']); ?></span>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <div class="row mb-7">
                                        ...
                                        <div class="row mb-7">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <span
                                                    class="fw-semibold fs-6"><?= ucwords($simper['company']); ?></span>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <div class="row mb-7">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <span
                                                    class="fw-semibold fs-6"><?= ucwords($simper['masaberlakuformat']); ?></span>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row mb-7">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <span
                                                    class="fw-semibold fs-6"><?= strtoupper($simper['gol_darah']); ?></span>
                                            </div>
                                            <!--end::Col-->
                                        </div>
